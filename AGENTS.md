...
**Frontend/ 配下で作業する場合は必ず `Frontend/AGENTS.md` も参照してください。**
Frontend固有のアーキテクチャ・コーディング規則・ドキュメント運用ルールはそちらに記載しています。
...
- `/Users/honmayuudai/MyHobby/hackson/KC3Hack2026/Frontend/transcript-focus-lab`: 解析ロジック試作・検証（静的 HTML/JS）
